  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        marginBottom: 5, textAlign: "start",
      }}>
        {displayValue}
      </div>
      ...
      {timestamp && displayValue !== "—" && (
        <div style={{ fontSize: 12, color: "#9CA3AF", marginBottom: 10, textAlign: "start" }}>
          {timestamp}
        </div>
      )}
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ textAlign: "start" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 5, flexDirection: "row" }}>
          ...
          {records.length === 0 ? (
            ...
            <div key={i} style={{
              ...
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap", flexDirection: "row" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 5, flexShrink: 0, flexDirection: "row" }}>
    ...
    <div style={{ maxWidth: 1024 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Avatar + name */}
          <div style={{ display: "flex", alignItems: "center", gap: 16, flexDirection: "row" }}>
            <div style={{
          ...
          {/* Action buttons */}
          <div style={{ display: "flex", gap: 10, flexShrink: 0, flexDirection: "row" }}>
            <button
              onClick={() => setShowEditModal(true)}
              data-testid="btn-edit-patient"
              style={{ display: "flex", alignItems: "center", gap: 6, background: "#F9FAFB", border: "1px solid #F1F1F1", borderRadius: 10, padding: "9px 16px", cursor: "pointer", fontSize: 14, color: "#717182", fontFamily: "'Cairo', sans-serif", flexDirection: "row" }}
            >
        ...
        <div style={{ marginBottom: 16 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 7, marginBottom: 10, flexDirection: "row" }}>
      ...
      <div style={{ ...card, paddingBottom: 28 }}>
        ...
        {allPatientVitals.length === 0 ? (
          <p style={{ color: "#717182", fontSize: 15, textAlign: "start" }}>
            {t("vitals.noData")}
          </p>
        ) : (
      ...
      <div style={card}>
        ...
        {/* Tab Nav */}
        <div style={{ display: "flex", gap: 4, borderBottom: "2px solid #F1F1F1", marginBottom: 24, flexDirection: "row" }}>
          {tabs.map(tab => (
            <button
              key={tab.id}
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {patientNotes.length === 0 ? (
                ...
                <div key={n.id} style={{ padding: "14px 18px", background: "#F9FAFB", borderRadius: 12, border: "1px solid #F1F1F1", display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexDirection: "row" }}>
                  <div style={{ textAlign: "start" }}>
      ...
      {deleteNoteId && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.45)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999 }}>
          <div style={{ background: "#fff", borderRadius: 16, padding: 36, maxWidth: 400, width: "90%", textAlign: "center", boxShadow: "0 20px 60px rgba(0,0,0,0.15)", direction: isRTL ? "rtl" : "ltr" }}>
