...
export default function PatientList() {
  ...
  return (
    <div>
      {/* Header */}
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 24, flexDirection: "row" }}>
        ...
        <button
          ...
          style={{
            ...
            flexDirection: "row", whiteSpace: "nowrap",
          }}
        >
      ...
      {/* Count */}
      <div style={{ marginBottom: 10, fontSize: 13, color: "#717182", textAlign: "start" }}>
        {countLabel}
      </div>
